...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⠀⠀⠀⠀⠀⠀⠀
`));
console.log(chalk.hex("#6f00f")("Baileys modified by: @faastecuuuu\n"));
console.log(chalk.hex("#6f00f")("Version 2.0.0 "));
console.log(chalk.hex("#6f00f")("Last Update: Minggu, 8 Januari "));
console.log(chalk.hex("#6f00f")("Thanks Udah Pake Bailys faa || senpaiii"));
